...
# Credits
```sh
k4ishna.404 (Reworked CnC and added some methods .-.)
k4ishna.404  (Example Panel and L7 methods <3)
k4ishna.404  (Layer 7 methods <3)
k4ishna.404  (Layer 7 methods <3)
k4ishna.404  (Layer 4 and AMP methods <3)
k4ishna.404  (Layer 4 and AMP methods <3)
k4ishna.404  (LAYER 7 METHODS <3)
k4ishna.404  (SPECIAL METHODS <3)
k4ishna.404  (HTTP, SOCKS5, SOCK4 proxies <3)
```
